...
function Home() { return <><header className="border-b px-6 py-4"><nav aria-label="ناوبری اصلی"><Link to="/">پنل فروشنده</Link></nav></header><main className="mx-auto max-w-4xl px-6 py-16"><h1 className="text-3xl font-bold">پنل فروشنده</h1><p className="mt-4">فروشگاه خود را بسازید و مدیریت کنید.</p><p className="mt-6 rounded-md bg-muted p-4">این بخش در حال آماده‌سازی است.</p><Button className="mt-6" disabled>به‌زودی</Button></main></>; }
